...
"""
    ...
    def test_download_filename_generation(self):
        ...
        safe_filename_special = "".join(c if c.isalnum() or c in "._-" else "_" for c in title_with_special) + ".docx"
    ...
    def test_conversion_options(self):
        ...
        self.assertIn(valid_options["diagram_style"], ["default", "neutral", "dark", "forest"])
