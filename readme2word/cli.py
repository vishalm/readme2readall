...
def convert_file(input_path: Path, output_filename: str, theme: str, debug: bool, include_toc: bool) -> bool:
...
def main():
    ...
    if not args.input_file:
        print("Error: Input file is required (or use --web for web interface)", file=sys.stderr)
        parser.print_help()
        sys.exit(1)
    ...
    success = convert_file(input_path, output_filename, args.theme, args.debug, include_toc)
